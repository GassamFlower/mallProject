...
public class SmsHomeAdvertiseController {
    ...
    @ResponseBody
    public CommonResult create(@RequestBody SmsHomeAdvertise advertise, Principal principal) {
        if(principal==null){
            return CommonResult.unauthorized(null);
        }
        String username = principal.getName();
        UmsAdmin umsAdmin = adminService.getAdminByUsername(username);
        advertise.setAdminId(umsAdmin.getId());
    ...
    public CommonResult<CommonPage<SmsHomeAdvertise>> list(@RequestParam(value = "name", required = false) String name,
        ...
        String username = principal.getName();
        UmsAdmin umsAdmin = adminService.getAdminByUsername(username);
        List<SmsHomeAdvertise> advertiseList = advertiseService.list(umsAdmin.getId(),name, type, endTime, pageSize, pageNum);
