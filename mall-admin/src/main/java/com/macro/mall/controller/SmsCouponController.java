...
public class SmsCouponController {
    ...
    @ResponseBody
    public CommonResult add(@RequestBody SmsCouponParam couponParam, Principal principal) {
        if(principal==null){
            return CommonResult.unauthorized(null);
        }
        String username = principal.getName();
        UmsAdmin umsAdmin = adminService.getAdminByUsername(username);
        couponParam.setAdminId(umsAdmin.getId());
    ...
    public CommonResult<CommonPage<SmsCoupon>> list(
        ...
        String username = principal.getName();
        UmsAdmin umsAdmin = adminService.getAdminByUsername(username);
        List<SmsCoupon> couponList = couponService.list(umsAdmin.getId(),name,type,pageSize,pageNum);
