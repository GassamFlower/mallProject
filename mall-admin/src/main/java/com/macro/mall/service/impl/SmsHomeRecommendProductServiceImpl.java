...
public class SmsHomeRecommendProductServiceImpl implements SmsHomeRecommendProductService {
    ...
    @Override
    public int create(List<SmsHomeRecommendProduct> homeRecommendProductList,Long adminId) {
        for (SmsHomeRecommendProduct recommendProduct : homeRecommendProductList) {
            recommendProduct.setAdminId(adminId);
    ...
    @Override
    public List<SmsHomeRecommendProduct> list(Long adminId,String productName, Integer recommendStatus, Integer pageSize, Integer pageNum) {
