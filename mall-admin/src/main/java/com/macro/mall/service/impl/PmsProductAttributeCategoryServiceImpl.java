...
public class PmsProductAttributeCategoryServiceImpl implements PmsProductAttributeCategoryService {
    ...
    @Override
    public int create(String name, Long adminId) {
        PmsProductAttributeCategory productAttributeCategory = new PmsProductAttributeCategory();
        productAttributeCategory.setName(name);
        productAttributeCategory.setAdminId(adminId);
    ...
    @Override
    public List<PmsProductAttributeCategory> getList(Integer pageSize, Integer pageNum, Long adminId) {
        PageHelper.startPage(pageNum,pageSize);
        PmsProductAttributeCategoryExample pmsProductAttributeCategoryExample = new PmsProductAttributeCategoryExample();
        pmsProductAttributeCategoryExample.createCriteria().andAdminIdEqualTo(adminId);
        return productAttributeCategoryMapper.selectByExample(pmsProductAttributeCategoryExample);
    }

    @Override
    public List<PmsProductAttributeCategoryItem> getListWithAttr(Long adminId) {
        return productAttributeCategoryDao.getListWithAttr(adminId);
    }
}
