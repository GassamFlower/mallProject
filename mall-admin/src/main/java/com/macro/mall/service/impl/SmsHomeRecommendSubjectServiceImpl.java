...
public class SmsHomeRecommendSubjectServiceImpl implements SmsHomeRecommendSubjectService {
    ...
    @Override
    public int create(List<SmsHomeRecommendSubject> recommendSubjectList,Long adminId) {
        for (SmsHomeRecommendSubject recommendSubject : recommendSubjectList) {
            recommendSubject.setAdminId(adminId);
    ...
    @Override
    public List<SmsHomeRecommendSubject> list(Long adminId,String subjectName, Integer recommendStatus, Integer pageSize, Integer pageNum) {
