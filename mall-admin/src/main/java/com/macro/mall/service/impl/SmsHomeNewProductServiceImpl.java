...
public class SmsHomeNewProductServiceImpl implements SmsHomeNewProductService {
    ...
    @Override
    public int create(List<SmsHomeNewProduct> homeNewProductList,Long adminId) {
        for (SmsHomeNewProduct SmsHomeNewProduct : homeNewProductList) {
            SmsHomeNewProduct.setAdminId(adminId);
    ...
    @Override
    public List<SmsHomeNewProduct> list(Long adminId,String productName, Integer recommendStatus, Integer pageSize, Integer pageNum) {
